...
import { OperatorBanActions } from "./operator-ban-actions";
            ...
            {list.length === 0 ? (
              ...
              list.map((p) => (
                <tr key={p.id} className="border-b border-tp-border last:border-0">
                  ...
                  <td className="px-4 py-3 text-sm">{p.banned ? "Yes" : "—"}</td>
                  <td className="px-4 py-3">
                  ...
                  <td className="px-4 py-3 text-right">
                    <div className="flex flex-wrap justify-end gap-2">
                      ...
                      {p.approval_status === "approved" && (
                        <OperatorBanActions profileId={p.id} banned={Boolean(p.banned)} />
                      )}
                    </div>
                  </td>
                </tr>
